...
export default function ManagerDashboard() {
  ...
  // FIXED: Synchronized visibility state object setup variables
  ...
  // FIXED: Hydrates rules using the unified structural key 'opolo_master_visibility'
  useEffect(() => {
  ...
  // FIXED: Saves visibility updates to the exact same shared key string
  ...
  const fetchGlobalStats = async () => {
    try {
      let query = supabase
        .from('students')
        .select(`amount_paid, institution_cost, staff_commission, consultant_commission, commission_earned, status, created_at, registration_source`)
      ...
      let totals = { gross: 0, commissions: 0, remittance: 0, net: 0, agent: 0 }
  ...
  return (
    <div className="min-h-screen bg-slate-50 font-sans p-6 md:p-12 relative overflow-x-hidden text-blue-950">
      <div className="max-w-7xl mx-auto">
        ...
        {/* DASHBOARD VISIBILITY SWITCH CONTROLLER BOARD PANEL */}
        <div className="mb-8 p-4 bg-white border border-slate-200 rounded-[1.5rem] shadow-sm flex flex-wrap gap-3 items-center">
          ...
          <div className="flex flex-wrap gap-2">
            ...
            >
              Staff Payouts: {visibility.showCommissions ? 'ON' : 'OFF'}
            </button>
            <button 
            ...
            >
              Institution Costs: {visibility.showRemittance ? 'ON' : 'OFF'}
            </button>
            <button 
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-4 mb-12">
          ...
          <Link href="/manager-wallets" className="group">
            <div className="bg-blue-900 p-6 rounded-[2rem] border border-blue-800 shadow-sm hover:shadow-xl hover:scale-[1.02] transition-all cursor-pointer h-full">
              ...
              <p className="text-blue-200 text-xs mt-1 font-medium">Add daily float cash to staff and reset balances.</p>
            </div>
          </Link>
          ...
          <Link href="/reports" className="group">
            <div className="bg-white p-6 rounded-[2rem] border border-slate-100 shadow-sm hover:shadow-xl transition-all cursor-pointer h-full">
              ...
              <p className="text-slate-400 text-xs mt-1 font-medium">Export CSV data and analyze performance.</p>
            </div>
          </Link>
          ...
          <Link href="/pending-jobs" className="group">
            <div className="bg-white p-6 rounded-[2rem] border border-slate-100 shadow-sm hover:shadow-xl transition-all cursor-pointer h-full">
              ...
              <p className="text-slate-400 text-xs mt-1 font-medium">Manage queue and cancel jobs for student refunds.</p>
            </div>
          </Link>
          ...
          <Link href="/logs" className="group">
            <div className="bg-white p-6 rounded-[2rem] border border-slate-100 shadow-sm hover:shadow-xl transition-all cursor-pointer h-full">
              ...
              <p className="text-slate-400 text-xs mt-1 font-medium">Monitor real-time staff activity and history logs.</p>
            </div>
          </Link>
          ...
          <Link href="/settings" className="group">
            <div className="bg-white p-6 rounded-[2rem] border border-slate-100 shadow-sm hover:shadow-xl hover:scale-[1.02] transition-all cursor-pointer h-full">
              ...
              <p className="text-slate-400 text-xs mt-1 font-medium">Configure commission formulas, prices, and system keys.</p>
            </div>
          </Link>
        </div>
